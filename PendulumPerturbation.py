...
def double_pen(m1, m2, l1, l2, theta1, theta2, g):
    ...
    M = m1+m2
#Simplifications for repetition between ODE for theta1doubledot and theta2doubledot   
    theta1d = T1
    theta2d = T2
...
#T1d is the second derivative of theta1, T2d is the second for theta 2
